...
{
    public partial class ViewProcessExecutionMaster
    {
        ...
        public int CompletedProcess { get; set; }
        public int BalProcess { get; set; }
        public int CompletedPer { get; set; }
        public int BalPer { get; set; }
        public string CompletedProcessName { get; set; }
        public string BalProcessName { get; set; }
