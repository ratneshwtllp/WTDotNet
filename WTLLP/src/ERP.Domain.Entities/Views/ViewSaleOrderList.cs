...
{
    public class ViewSaleOrderList
    {
        ...
        public string EdgeColor { set; get; }
        public string HandTag { set; get; }
        public string Label { set; get; }
        public string CareLabel { set; get; }
        public string Logo { set; get; }
        public string BuyerEmail { set; get; }
        public int EmailStatus { set; get; }
